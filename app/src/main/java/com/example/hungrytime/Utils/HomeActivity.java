package com.example.hungrytime.Utils;
...
//        <item>Update Account</item>
    ...
    protected void onResume() {
        super.onResume();
        /*
        * Update the recyceler view so that the newly updated task must be added to the list*/
        setUpAdapter();
    }

    // Implementing the function of my interface located in Helper package used to swip left to delete
    @Override
